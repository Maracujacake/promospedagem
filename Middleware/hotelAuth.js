...
const autenticarHotel = (req, res, next) => {
    ...
    try {
        ...
        // Verifica se o usuário é hotel
        if (decoded.userType !== 'hotel') {
            return res.status(403).json({ message: 'Acesso negado: apenas hotel podem acessar esta página' });
        }
...
module.exports =  autenticarHotel;